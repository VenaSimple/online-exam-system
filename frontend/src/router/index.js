...
const routes = [
  ...
  // 管理端
  {
    ...
    children: [
      ...
      { path: 'course/edit/:id?', name: 'AdminCourseEdit', component: () => import('../views/admin/CourseEdit.vue') },
      { path: 'questions', name: 'AdminQuestions', component: () => import('../views/admin/Questions.vue') },
      { path: 'question/edit/:id?', name: 'AdminQuestionEdit', component: () => import('../views/admin/QuestionEdit.vue') },
