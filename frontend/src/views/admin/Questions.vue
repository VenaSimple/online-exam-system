    ...
    <el-card>
      <div style="display:flex;justify-content:space-between;margin-bottom:16px">
        ...
        <div style="display:flex;gap:8px">
          <el-button type="primary" @click="router.push('/admin/question/edit')">新增题目</el-button>
      ...
      <el-table :data="questions" stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" width="180">
          <template #default="{ row }">
            <el-button size="small" @click="router.push(`/admin/question/edit/${row.id}`)">编辑</el-button>
...
import { getQuestionList, deleteQuestion, batchDeleteQuestions, getAllQuestionCategories } from '../../api/question'
...
async function handleBatchDelete() {
  await ElMessageBox.confirm(`确定批量删除 ${selectedIds.value.length} 道题目？`, '提示', { type: 'warning' })
