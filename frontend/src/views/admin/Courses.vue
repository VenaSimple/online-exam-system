    ...
    <el-card>
      <div style="display:flex;justify-content:space-between;margin-bottom:16px">
        ...
        <div style="display:flex;gap:12px;align-items:center">
          <el-input v-model="keyword" placeholder="搜索课程" style="width:200px" @keyup.enter="loadData" clearable />
          <el-button type="primary" @click="router.push('/admin/course/edit')">新增课程</el-button>
        </div>
      </div>
      <el-table :data="courses" stripe>
        ...
        <el-table-column label="操作" width="260">
          <template #default="{ row }">
            <el-button size="small" @click="router.push(`/admin/course/edit/${row.id}`)">编辑</el-button>
